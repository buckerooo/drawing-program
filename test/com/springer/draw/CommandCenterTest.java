...
public class CommandCenterTest {
    ...
    public void canCreateDrawRectangleCommandGivenValidInputs() {
        assertThat(new CommandCenter(new Canvas()).buildCommand("R 16 1 20 3"), instanceOf(DrawRectangle.class));
    }
    ...
    public void blowsUpWhenYouTryAndDrawARectangleWithInvalidInputs() {
        ...
        willThrowExceptionWithMessage((x) -> new CommandCenter(new Canvas()).buildCommand("R"), drawRectangleError);
        willThrowExceptionWithMessage((x) -> new CommandCenter(new Canvas()).buildCommand("R 1"), drawRectangleError);
        willThrowExceptionWithMessage((x) -> new CommandCenter(new Canvas()).buildCommand("R 1 2"), drawRectangleError);
        willThrowExceptionWithMessage((x) -> new CommandCenter(new Canvas()).buildCommand("R 1 2 6"), drawRectangleError);
        willThrowExceptionWithMessage((x) -> new CommandCenter(new Canvas()).buildCommand("R 1 2 6 a"), drawRectangleError);
        willThrowExceptionWithMessage((x) -> new CommandCenter(new Canvas()).buildCommand("R 1 2 6 a"), drawRectangleError);
        willThrowExceptionWithMessage((x) -> new CommandCenter(new Canvas()).buildCommand("R 1 2 b 2"), drawRectangleError);
        willThrowExceptionWithMessage((x) -> new CommandCenter(new Canvas()).buildCommand("R 1 c 6 2"), drawRectangleError);
        willThrowExceptionWithMessage((x) -> new CommandCenter(new Canvas()).buildCommand("R d 2 6 2"), drawRectangleError);
        willThrowExceptionWithMessage((x) -> new CommandCenter(new Canvas()).buildCommand("R -1 2 6 2"), drawRectangleError);
        willThrowExceptionWithMessage((x) -> new CommandCenter(new Canvas()).buildCommand("R 1 -2 6 2"), drawRectangleError);
        willThrowExceptionWithMessage((x) -> new CommandCenter(new Canvas()).buildCommand("R 1 2 -6 2"), drawRectangleError);
        willThrowExceptionWithMessage((x) -> new CommandCenter(new Canvas()).buildCommand("R 1 2 6 -2"), drawRectangleError);
        willThrowExceptionWithMessage((x) -> new CommandCenter(new Canvas()).buildCommand("R 0 2 6 2"), drawRectangleError);
        willThrowExceptionWithMessage((x) -> new CommandCenter(new Canvas()).buildCommand("R 1 0 6 2"), drawRectangleError);
        willThrowExceptionWithMessage((x) -> new CommandCenter(new Canvas()).buildCommand("R 1 2 0 2"), drawRectangleError);
        willThrowExceptionWithMessage((x) -> new CommandCenter(new Canvas()).buildCommand("R 1 2 6 0"), drawRectangleError);
    }

    @Test
    public void canCreateFillAreaCommandGivenValidInputs() {
        assertThat(new CommandCenter(new Canvas()).buildCommand("B 10 3 o"), instanceOf(FillArea.class));
    }
    ...
    public void blowsUpWhenYouTryAndCreateAFillAreaCommandWithInvalidInputs() {
        ...
        willThrowExceptionWithMessage((x) -> new CommandCenter(new Canvas()).buildCommand("B"), createCanvasError);
        willThrowExceptionWithMessage((x) -> new CommandCenter(new Canvas()).buildCommand("B 10"), createCanvasError);
        willThrowExceptionWithMessage((x) -> new CommandCenter(new Canvas()).buildCommand("B 10 5"), createCanvasError);
        willThrowExceptionWithMessage((x) -> new CommandCenter(new Canvas()).buildCommand("B 10 a 0"), createCanvasError);
        willThrowExceptionWithMessage((x) -> new CommandCenter(new Canvas()).buildCommand("B a 5 0"), createCanvasError);
        willThrowExceptionWithMessage((x) -> new CommandCenter(new Canvas()).buildCommand("B 10 0 o"), createCanvasError);
        willThrowExceptionWithMessage((x) -> new CommandCenter(new Canvas()).buildCommand("B 0 5 o"), createCanvasError);
